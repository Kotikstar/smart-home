...
$translations = [
    'ru' => [
        ...
        'nav.carbook' => 'Автокнига',
        'nav.login' => 'Вход',
        'nav.logout' => 'Выход',
        'nav.language' => 'Язык',
        'lang.ru' => 'Русский',
        'lang.en' => 'English',
        'carbook.badge' => 'Автокнига',
        ...
        'carbook.action.update_expense' => 'Сохранить правку',
        'carbook.action.cancel' => 'Отмена',
        'carbook.action.edit' => 'Править',
        'carbook.action.toggle_done' => 'Готово',
        'carbook.message.saved' => 'Сохранено',
        'carbook.message.error' => 'Ошибка',
        'carbook.message.no_wishes' => 'Нет хотелок — добавьте первую.',
        'carbook.message.no_expenses' => 'Пока нет расходов для этого авто.',
        'carbook.message.no_events' => 'Записей пока нет.',
    ],
    'en' => [
        ...
        'carbook.action.update_expense' => 'Save change',
        'carbook.action.cancel' => 'Cancel',
        'carbook.action.edit' => 'Edit',
        'carbook.action.toggle_done' => 'Done',
        'carbook.message.saved' => 'Saved',
        'carbook.message.error' => 'Error',
        'carbook.message.no_wishes' => 'No wishes yet — add the first item.',
        'carbook.message.no_expenses' => 'No expenses for this vehicle yet.',
        'carbook.message.no_events' => 'No records yet.',
    ],
];
