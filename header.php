...
<body class="text-white">
  ...
  <nav class="glass-nav p-4 sticky top-0 z-30">
    <div class="max-w-7xl mx-auto flex flex-wrap items-center gap-3 text-sm">
      ...
      <form method="post" action="set_language.php" class="ml-auto flex items-center gap-2 bg-white/5 px-3 py-1 rounded-full border border-white/10 text-xs">
      ...
      <div class="flex items-center gap-2" id="auth-cta">
